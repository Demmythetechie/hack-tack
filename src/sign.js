            ...
            <section className="flex flex-row w-[100%] h-[90vh] min-[530px]:h-[100vh]">
                ...
                <form onSubmit={signup} className={`${(notExist) ? 'hidden' : 'flex'} w-[100%] min-[530px]:w-[60%] sm:w-[55%] md:w-[45%] lg:w-[35%] xl:w-[35%] h-[100%] sm:h-[95%] md:h-[95%] lg:h-[100%] xl:h-[100%] flex-col items-center justify-center gap-y-[4%] relative min-[530px]:relative sm:absolute md:absolute lg:relative xl:relative bg-white/50  sm:top-[2.5%] sm:left-[20%] md:top-[2.5%] md:left-[27.5%] lg:top-[0%] lg:left-[0%] xl:top-[0%] xl:left-[0%]`}>
                    ...
                    <div className="flex flex-col items-center w-[80%] gap-y-[4vw] min-[530px]:gap-y-[2vw]">
                        ...
                        <input className={`${(loading) ? 'hidden' : 'block'} w-[100%] aspect-[1/0.12] max-[1280px]:h-[70%] pl-[3%] font-[ubuntu] text-sm sm:text-sm md:text-sm lg:text-sm xl:text-sm font-semibold focus:outline-none focus:border focus:border-black bg-black text-white`} type="submit" id="done" name="done" value={`${signin === true ? 'Sign In' : 'Create account'}`} />
